...
\end{equation}
The decision expressed by the non-parametric learning function $f^*(\Drm)$ for a given novel observation $\xrm$ is
...
\todohi{Use harder non-linearity that fails even for higher-order poly??}

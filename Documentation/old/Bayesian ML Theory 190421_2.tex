...
\begin{IEEEeqnarray}{rCl}
\mathrm{Bias}(y,x) & = & \Erm_{\Drm | \uptheta} \big[ \Prm_{\yrm,\xrm | \Drm}(y,x | \Drm) - \Prm_{\yrm,\xrm | \uptheta}(y,x | \uptheta) \big] \\
...
The expected conditional variance of the estimate $\Prm(\yrm,\xrm | \Drm)$ is
\begin{IEEEeqnarray}{L}
...
\quad = \mathrm{Bias}(y,x) \mathrm{Bias}(y',x') + \Crm_{\Drm | \uptheta} \big[\Prm_{\yrm,\xrm | \Drm}(\cdot,\cdot | \Drm) \big](y,x,y',x') \nonumber \;,
\end{IEEEeqnarray}
...
It is also informative to compare the unknown conditional PMF $\Prm(\yrm | \xrm,\uptheta)$ with the estimated distribution $\Prm(\yrm | \xrm,\Drm)$. For a given $\xrm$ and corresponding number of training samples $\nrm'(\xrm)$, the expected value of the estimate condtioned on the true model $\uptheta$ is
\begin{IEEEeqnarray}{L}
...
\end{IEEEeqnarray}
where the covariance function of a multinomial random process has been used.

The expected squared difference between the estimate and the true conditional model is
\begin{IEEEeqnarray}{L}
\mathcal{E}(y,y') \\
\quad = \Erm_{\xrm,\Drm | \uptheta} \Big[ \big( \Prm_{\yrm | \xrm,\Drm}(y | \xrm,\Drm) - \Prm_{\yrm | \xrm,\uptheta}(y | \xrm,\uptheta) \big) \big( \Prm_{\yrm | \xrm,\Drm}(y' | \xrm,\Drm) - \Prm_{\yrm | \xrm,\uptheta}(y' | \xrm,\uptheta) \big) \Big] \nonumber \\
\quad = \Erm_{\xrm,\nrm' | \uptheta}\Big[ \mathrm{Bias}(y;\xrm,\nrm') \mathrm{Bias}(y';\xrm,\nrm') + \Crm_{\nbarrm | \nrm',\uptheta} \big[\Prm_{\yrm | \xrm,\nbarrm}(\cdot | \xrm,\nbarrm) \big](y,y') \Big] \nonumber \\ 

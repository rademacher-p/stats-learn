...
& = & \left(\frac{M}{N+M}\right) M^{-1} + \left(\frac{N}{N+M}\right) N^{-1}\sum_{n=1}^N \delta\big [\Drm(n),\yrm \big] \nonumber \;.
\end{IEEEeqnarray}
...
%\in \bm{\Theta} = \left\{ \bm{\theta} \in {\mathbb{R}^+}^{\Ycal \times \Xcal}: \sum_{y \in \Ycal} \sum_{x \in \Xcal}  \theta(y,x) = 1 \right\} \;,
%\end{equation}
such that $\text{P}_{\yrm,\xrm}(y,x | \bm{\theta}) = \theta(y,x)$.
...
\begin{IEEEeqnarray}{rCl}
\bar{N}(\yrm,\xrm;\Drm) & = & \sum_{n=1}^N \delta \big[ \Drm(n),(\yrm,\xrm) \big] \\
& = & \sum_{n=1}^N \delta \left[ \Yrm(n),\yrm \right] \delta \left[ \Xrm(n),\xrm \right] \nonumber \;.
\end{IEEEeqnarray}
...
\text{P}(\yrm | \xrm,\Drm) & = & \frac{\text{P}(\yrm,\xrm | \Drm)}{\sum_{\yrm' \in \Ycal} \text{P}(\yrm',\xrm | \Drm)} \\
& = & \frac{\bar{N}(\yrm,\xrm;\Drm)+1}{N'(\xrm;\Drm) + M_y} \nonumber \;,
\end{IEEEeqnarray}
where $N'(x;\Drm) \equiv \sum_{y \in \Ycal} \bar{N}(y,x;\Drm) = \sum_{n=1}^N \delta\big[ \Xrm(n),x \big]$.
...
&& \qquad (N+M)! \prod_{y' \in \Ycal} \prod_{x' \in \Xcal} \frac{\bm{\theta}(y,\xrm)^{\bar{N}\big( y,\xrm;( \Drm,(y',x') ) \big)}}{\bar{N}\big( y,\xrm;( \Drm,(y',x') ) \big) !} \nonumber \\
& = & \sum_{y \in \Ycal} \frac{\bar{N}(y,\xrm;\Drm)+1}{N'(\xrm;\Drm) + M_y} \text{Dir}\left( \bm{\theta} ; \bar{\bm{N}}\Big( \big( \Drm,(y',\xrm) \big) \Big) + \bm{1}_{M_y \times M_x} \right) \nonumber\;.
\end{IEEEeqnarray}
...
\qquad \left( \frac{N'(\xrm;\Drm)}{N'(\xrm;\Drm) + M_y} \right) \frac{\sum_{n=1}^N \delta\big[ \Xrm(n),\xrm \big] \mathcal{L}\big( h,\Yrm(n) \big)}{ N'(\xrm;\Drm)} \nonumber \;,
\end{IEEEeqnarray}

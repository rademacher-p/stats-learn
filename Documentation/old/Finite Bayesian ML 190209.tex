...
\text{P}_{\yrm}(y|\bm{\theta}) = \text{P}(\yrm = y | \bm{\theta}) = \theta(y) \;, \\
\text{P}_{\Drm(n)}(y|\bm{\theta}) = \text{P}(\Drm(n) = y | \bm{\theta}) = \theta(y) \;.
\end{IEEEeqnarray}
...
& = & \text{E}_{\yrm,\Drm}\left[ \mathcal{L}(f(\Drm),\yrm) \right] \\
& = & \text{E}_{\Drm}\left[ \text{E}_{\yrm | \Drm} [ \mathcal{L}(f(\Drm),\yrm) ] \right] \;.
\end{IEEEeqnarray}
...
\text{E}_{\yrm | \Drm} [ \mathcal{L}(h,\yrm) ] = \sum_{y \in \Ycal} \mathcal{L}(h,y) \text{P}(y | \Drm) \\
= \frac{\sum_{y \in \Ycal} \mathcal{L}(h,y) + \sum_{n=1}^N \mathcal{L}(h,D(n))}{N+M} \\
= \left( \frac{M}{N+M} \right) \sum_{y \in \Ycal} \mathcal{L}(h,y) M^{-1} +  \left( \frac{N}{N+M} \right) \sum_{y \in \Ycal} \mathcal{L}(h,y) \frac{\bar{N}(y;D)}{N} \\
= \left( \frac{M}{N+M} \right) M^{-1} \sum_{y \in \Ycal} \mathcal{L}(h,y) +  \left( \frac{N}{N+M} \right) N^{-1} \sum_{n=1}^N \mathcal{L}(h,D(n)) \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\text{E}_{\yrm | \Drm} [ \mathcal{L}(h,\yrm) ] & = & 1 - \text{P}_{\yrm | \Drm}(h | \Drm) \\
...
\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f^*) & = & \text{E}_{\Drm} \left[ \text{E}_{\yrm | \Drm} [ \mathcal{L}(f^*(\Drm),\yrm) ] \right]
= 1 - \text{E}_{\Drm} \left[ \max_{y} \text{P}_{\yrm | \Drm}(y | \Drm) \right] \\
& = & 1 - \text{E}_{\Drm} \left[ \frac{\max_{y \in \Ycal} \bar{N}(y;\Drm) + 1}{N+M} \right] \\\
& = & 1 - \left( \frac{M}{N+M} \right) M^{-1} - \left( \frac{N}{N+M} \right) \frac{\text{E}_{\Drm} \left[ \max_{y \in \Ycal} \bar{N}(y;\Drm) \right]}{N} \;. \label{risk_01_opt}
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f^*) & = & 1 - \text{E}_{\Drm} \left[ \frac{\max_y \bar{N}(y;D) + 1}{N+M} \right] \\
...
\text{E}_{\yrm | \Drm} [ \mathcal{L}(h,\yrm) ] & = & \sum_{y=1}^M (h-y)^2 \text{P}_{\yrm | \Drm}(y) \;.
\end{IEEEeqnarray}
...
& = & \sum_{y=1}^M y \text{P}_{\yrm | \Drm}(y) \equiv \mu_{\yrm | \Drm} \\
...
\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f^*) & = & \text{E}_{\Drm} \left[ \text{E}_{\yrm | \Drm} [ \mathcal{L}(f^*(\Drm),\yrm) ] \right]
= \text{E}_{\Drm} \left[ \text{E}_{\yrm | \Drm} [ (\yrm - \mu_{\yrm | \Drm})^2 ] \right] \\
...
\Sigma_{\yrm | \nbarrm} & = & \text{E}_{\yrm | \nbarrm}[\yrm^2]
- \left( \text{E}_{\yrm | \nbarrm}[\yrm] \right)^2 \\
& = & \sum_{y=1}^M y^2 \text{P}_{\yrm | \nbarrm}(y) - \left( \sum_{y=1}^M y \text{P}_{\yrm | \nbarrm}(y) \right)^2 \\
& = & \sum_{y=1}^M y^2 \frac{\bar{\nrm}(y) + 1}{N+M} - \sum_{y_1=1}^M y_1 \sum_{y_2=1}^M y_2 \frac{(\bar{\nrm}(y_1) + 1)(\bar{\nrm}(y_2) + 1)}{(N+M)^2} \;.
\end{IEEEeqnarray}
...
\begin{equation}
\text{P}_{\Drm(n)}(y,x | \bm{\theta}) = \theta(y,x) \;.
\end{equation}

The design objective generalizes naturally. Using the same user-specified loss function $\mathcal{L}: \mathcal{H} \times \Ycal \mapsto \mathbb{R}^+$, we define the conditonal risk,

\begin{equation}
\mathcal{R}_{\bm{\Theta}}(f,\bm{\theta}) = \text{E}_{\Drm | \bm{\theta}} \left[ \text{E}_{\yrm,\xrm | \bm{\theta}} \left[ \mathcal{L}(f(\xrm,\Drm),\yrm) \right] \right] \;,
\end{equation}
...
\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f) & = & \text{E}_{\bm{\theta}}\left[  \mathcal{R}_{\bm{\theta}}(f,\bm{\theta}) \right] \\
& = & \text{E}_{\yrm,\xrm,\Drm}\left[ \mathcal{L}(f(\xrm,\Drm),\yrm) \right] \\
& = & \text{E}_{\xrm,\Drm}\left[ \text{E}_{\yrm | \xrm,\Drm} [ \mathcal{L}(f(\xrm,\Drm),\yrm) ] \right] \;.
\end{IEEEeqnarray}
...
f^*(\xrm,\Drm) = \argmin_{h \in \mathcal{H}} \text{E}_{y | \xrm,\Drm}\left[ \mathcal{L}(h,y) \right] \;,
\end{equation}

which achieves the minimum risk,

\begin{equation} \label{risk_min_IO}
\mathcal{R}(f^*) = \text{E}_{\xrm,\Drm} \left[ \min_{h \in \mathcal{H}} \text{E}_{y | \xrm,\Drm}\left[ \mathcal{L}(h,y) \right] \right] \;.
\end{equation}
...
\begin{IEEEeqnarray}{rCl}
\text{P}(D) & = & \int_{\bm{\Theta}} \left[ \prod_{n=1}^N \text{P}(D(n) | \bm{\theta}) \right] \text{p}(\bm{\theta}) \mathrm{d}\bm{\theta} \\
& = & \text{E}_{\bm{\theta}} \left[ \prod_{y \in \Ycal} \prod_{x \in \Xcal} \bm{\theta}(y,x)^{\bar{N}(y,x;D)} \right] \;,
\end{IEEEeqnarray}
...
\text{P}(y | x,D) & = & \frac{\text{P}(y,x | D)}{\sum_{y' \in \Ycal} \text{P}(y',x | D)} \\
& = & \frac{\bar{N}(y,x;D)+1}{\sum_{y' \in \Ycal} \bar{N}(y',x;D) + M_y} \;.
\end{IEEEeqnarray}

Observe the similarities to the formula of $\text{P}(y|D)$ established for the basic model. We can rework this expression to mirror equation \eqref{P_y_D}; defining $N'(x;D) \equiv \sum_{y \in \Ycal} \bar{N}(y,x;D) = \sum_{n=1}^N \delta[X(n),x]$ for notational convenience, we have,
...
&& \qquad (N+M)! \prod_{y' \in \Ycal} \prod_{x' \in \Xcal} \frac{\bm{\theta}(y,x)^{\bar{N}(y,x;\{D,\{y',x'\}\})}}{(\bar{N}(y,x;\{D,\{y',x'\}\}))!}\\
& = & \sum_{y \in \Ycal} \frac{\bar{N}(y,x;D)+1}{N'(x;D) + M_y} \text{Dir}\left( \bm{\theta} ; \bar{\bm{N}}(\{D,\{y',x'\}\}) + \bm{1}_{M_y \times M_x} \right) \;.
\end{IEEEeqnarray}
...
& = & \text{E}_{\bm{\theta} | x,D} \left[ \frac{\theta(y,x)}{\sum_{y' \in \Ycal} \theta(y',x)} \right]
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\yrm | \xrm,\Drm} [ \mathcal{L}(h,\yrm) ] = \sum_{y \in \Ycal} \mathcal{L}(h,y) \text{P}(y | x,\Drm) \\
= \left( \frac{M_y}{N'(x;D) + M_y} \right) \sum_{y \in \Ycal} \mathcal{L}(h,y) \frac{1}{M_y} +  \\
\qquad \left( \frac{N'(x;D)}{N'(x;D) + M_y} \right) \sum_{y \in \Ycal} \mathcal{L}(h,y) \frac{\bar{N}(y,x;D)}{N'(x;D)} \\
= \left( \frac{M_y}{N'(x;D) + M_y} \right) M_y^{-1} \sum_{y \in \Ycal} \mathcal{L}(h,y) +  \\
...
\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f^*) & = & \text{E}_{\xrm,\Drm} \left[ \text{E}_{\yrm | \xrm,\Drm} [ \mathcal{L}(f^*(\xrm,\Drm),\yrm) ] \right]
...
& = & 1 - \sum_{x \in \Xcal} \frac{\text{E}_{\Drm} \left[\max_{y} \bar{N}(y,x;D) \right] + 1}{N+M} \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
F_{\bar{\nrm}_{\text{max}}^k}(n) & = & \text{P}\left( \bar{\nrm}_{\text{max}}^k \leq n \right) \\
...
\begin{IEEEeqnarray}{rCl}
f^*(x,D) & = & \argmin_{h \in \mathbb{R}} \text{E}_{\yrm | \xrm,\Drm} \left[ (h-\yrm)^2 \right] \\
& = & \sum_{y=1}^{M_y} y \text{P}_{\yrm | \xrm,\Drm}(y | x, D) \equiv \mu_{\yrm | \xrm,\Drm}(x, D) \\
...
Again, we have a convex combination of two conditional means. Now, the weighting factors depend on the cardinality $M_y$ and the number of training data with inputs matching the currently observed value of $\xrm$, $N'(x;D)$.



\subsubsection{Minimum Risk: Expected Posterior Variance}

Under the general model, the optimal learning function is the expected value $\yrm$ additionaly conditioned on the observed variable $\xrm$; similarly, the minimum risk is the expected value of the variance of $\text{P}(y|\xrm,\Drm)$,

\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f^*) & = & \text{E}_{\xrm,\Drm} \left[ \text{E}_{\yrm | \xrm,\Drm} [ \mathcal{L}(f^*(\xrm,\Drm),\yrm) ] \right]
= \text{E}_{\xrm,\Drm} \left[ \text{E}_{\yrm | \xrm,\Drm} [ (\yrm - \mu_{\yrm | \xrm,\Drm})^2 ] \right] \\
& = &  \text{E}_{\xrm,\Drm} \left[ \Sigma_{\yrm | \xrm,\Drm} \right] \\
...
\begin{IEEEeqnarray}{rCl}
\text{E}_{\xrm,\nbarrm} \left[ \text{E}_{\yrm | \xrm,\nbarrm}[\yrm^2] \right] & = & \sum_{\bar{\bm{n}} \in \bar{\Ncal}} \sum_{x=1}^{M_x} \text{P}(x,\bar{\bm{n}}) \sum_{y=1}^{M_y} y^2 \text{P}(y | x,\bar{\bm{n}}) \\
& = & \sum_{x=1}^{M_x} \sum_{y=1}^{M_y} y^2 \text{E}_{\nbarrm} \left[ \text{P}(y,x | \bar{\bm{n}}) \right] \\
...
\begin{IEEEeqnarray}{C}
\text{E}_{\xrm,\nbarrm} \left[ \left( \text{E}_{\yrm | \xrm,\nbarrm}[\yrm] \right)^2 \right] =
\sum_{\bar{\bm{n}} \in \bar{\Ncal}} \sum_{x=1}^{M_x} \text{P}(x,\bar{\bm{n}}) \left( \sum_{y=1}^{M_y} y \text{P}(y | x,\bar{\bm{n}}) \right)^2 \\
= \sum_{x=1}^{M_x} \sum_{y=1}^{M_y} y \sum_{y'=1}^{M_y} y' \text{E}_{\nbarrm} \left[ \text{P}(y,x | \bar{\bm{n}}) \text{P}(y' | x,\bar{\bm{n}}) \right] \\
= \frac{1}{N+M} \sum_{x=1}^{M_x} \sum_{y=1}^{M_y} y \sum_{y'=1}^{M_y} y' \text{E}_{\nbarrm} \left[ \frac{(\bar{n}(y,x)+1)(\bar{n}(y',x)+1)}{\sum_{y''=1}^{M_y}\bar{n}(y'',x) + M_y} \right] \\
...
\begin{IEEEeqnarray}{rCl}
\text{p}(\bm{\theta}) & = & \sum_{y \in \Ycal} \frac{\alpha(y)}{\alpha_0} \delta\left( \bm{\theta} - \bm{e}(y) \right) \\
& = & \sum_{y \in \Ycal} \frac{\alpha(y)}{\alpha_0} \prod_{y' \in \Ycal} \delta \left( \theta(y') - \delta[y,y'] \right) \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\text{P}(\bar{\bm{n}}) & = & \binom{N}{\bar{\bm{n}}} \prod_{y \in \Ycal} \left(\frac{\alpha(y)}{\alpha_0}\right)^{\bar{n}(y)} \\
& = & \binom{N}{\bar{\bm{n}}} \alpha_0^{-N} \prod_{y \in \Ycal} \alpha(y)^{\bar{n}(y)} \;.
\end{IEEEeqnarray}

Conversely, for $\alpha_0 \longrightarrow 0$, the PDF trends toward

\begin{IEEEeqnarray}{rCl}
\text{P}(\bar{\bm{n}}) & = & \sum_{y \in \Ycal} \frac{\alpha(y)}{\alpha_0} \delta\left[ \bar{\bm{n}} , N \bm{e}(y) \right] \\
& = & \sum_{y \in \Ycal} \frac{\alpha(y)}{\alpha_0} \prod_{y' \in \Ycal} \delta \left[ \bar{n}(y') , N \delta[y,y'] \right] \;.
\end{IEEEeqnarray}

\begin{IEEEeqnarray}{rCl}
\text{P}(D) & = & \sum_{y \in \Ycal} \frac{\alpha(y)}{\alpha_0} \delta\left[ D , (y,\ldots,y) \right] \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCL}
\text{p}(\bm{\theta} | D) & = & \frac{\text{P}(D | \bm{\theta}) \text{p}(\bm{\theta})}{\text{P}(D)} \\
& = & \beta \left( \bm{\alpha} + \bar{\bm{N}}(D) \right)^{-1} \prod_{y \in \Ycal} \theta(y)^{\alpha(y) + \bar{N}(y;D) - 1} \;,
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\yrm | \Drm} [ \mathcal{L}(h,\yrm) ] = \sum_{y \in \Ycal} \mathcal{L}(h,y) \text{P}(y | \Drm) \\
= \frac{\sum_{y \in \Ycal} \alpha(y) \mathcal{L}(h,y) + \sum_{y \in \Ycal} \bar{N}(y;D) \mathcal{L}(h,y)}{\alpha_0+N} \\
= \frac{\sum_{y \in \Ycal} \alpha(y) \mathcal{L}(h,y) + \sum_{n=1}^N \mathcal{L}(h,D(n))}{\alpha_0+N} \\
= \left( \frac{\alpha_0}{\alpha_0+N} \right) \sum_{y \in \Ycal} \mathcal{L}(h,y) \frac{\alpha(y)}{\alpha_0} +  \left( \frac{N}{\alpha_0+N} \right) N^{-1} \sum_{n=1}^N \mathcal{L}(h,D(n)) \\
= \left( \frac{\alpha_0}{\alpha_0+N} \right) \text{E}_{\yrm}[\mathcal{L}(h,y)] +  \left( \frac{N}{\alpha_0+N} \right) N^{-1} \sum_{n=1}^N \mathcal{L}(h,D(n)) \;.
\end{IEEEeqnarray}
...
In this section we generalize the previous results for the 0-1 loss function $\mathcal{L}(h,y) = 1 - \delta[h,y]$ and the class hypothesis space $\mathcal{H} = \Ycal$.
...
\begin{IEEEeqnarray}{rCl}
f^*(D) & = & \argmax_{y \in \Ycal} \text{P}(y|D) \\
& = & \argmax_{y \in \Ycal} \left( \alpha(y) + \bar{N}(y;D) \right) \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\mathcal{R}(f^*) & = & 1 - \frac{\text{E}_{\bar{\bm{n}}} \left[ \max_{y \in \Ycal} \left( \alpha(y) + \bar{n}(y) \right) \right]}{\alpha_0 + N}
\end{IEEEeqnarray}
...
For $\alpha_0 \longrightarrow \infty$, we have $\mathcal{R}(f^*) = 1 - \max_{y \in \Ycal} \alpha(y) / \alpha_0$.
...
\begin{IEEEeqnarray}{rCl}
f^*(D) & = & \argmin_{h \in \mathbb{R}} \text{E}_{\yrm|D} \left[ (h-\yrm)^2 \right]  \\
& = & \mu_{\yrm|D} = \text{E}_{\bm{\theta} | D} \left[ \mu_{\yrm|\bm{\theta}} \right] \\
& = & \left( \frac{\alpha_0}{\alpha_0+N} \right) \sum_{y \in \Ycal} y \frac{\alpha(y)}{\alpha_0} +  \left( \frac{N}{\alpha_0+N} \right) \frac{1}{N} \sum_{n=1}^N D(n) \;.
\end{IEEEeqnarray}
...
\Sigma_{\yrm | \nbarrm} & = & \text{E}_{\yrm | \nbarrm}[\yrm^2]
- \left( \text{E}_{\yrm | \nbarrm}[\yrm] \right)^2 \\
& = & \sum_{y \in \Ycal} y^2 \frac{\alpha(y) + \bar{\nrm}(y)}{\alpha_0 + N} - \sum_{y' \in \Ycal} y' \sum_{y'' \in \Ycal} y'' \frac{\left( \alpha(y') + \bar{\nrm}(y') \right) \left(\alpha(y'') + \bar{\nrm}(y'') \right)}{(\alpha_0 + N)^2} \;.
\end{IEEEeqnarray}
...
\left[ \left( \sum_{y \in \Ycal} \text{P}(y) y^2 \right) - \left( \sum_{y \in \Ycal} \text{P}(y) y \right)^2 \right] \\
...
\begin{IEEEeqnarray}{rCl}
\text{p}(\bm{\theta} | D) & = & \frac{\text{P}(D | \bm{\theta}) \text{p}(\bm{\theta})}{\text{P}(D)} \\
& = & \beta \left( \bm{\alpha} + \bar{\bm{N}}(D) \right)^{-1} \prod_{y \in \Ycal} \prod_{x \in \Xcal} 
...
\begin{IEEEeqnarray}{rCl}
\text{p}(\bm{\theta} | \xrm, \Drm) & = & \frac{\text{P}(x|\bm{\theta}) \text{p}(\bm{\theta}|D)}{\text{P}(x|D)} = \text{E}_{y|x,D} \left[ \text{p}(\bm{\theta} | y,x,D) \right]\\
& = & \sum_{y \in \Ycal} \frac{\alpha(y,x) + \bar{N}(y,x;D)}{\alpha'(x) + N'(x;D)} \text{Dir}\left( \bm{\theta} ; \bar{\bm{N}}(\{D,\{y',x'\}\}) + \bm{\alpha} \right) \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\yrm | \xrm,\Drm} [ \mathcal{L}(h,\yrm) ] 
= \sum_{y \in \Ycal} \mathcal{L}(h,y) \text{P}(y | \xrm,\Drm) \\
= \frac{\sum_{y \in \Ycal} \alpha(y,x) \mathcal{L}(h,y) + \sum_{y \in \Ycal} \bar{N}(y,x;D) \mathcal{L}(h,y)}{\alpha'(x) + N'(x;D)} \\
= \frac{\sum_{y \in \Ycal} \alpha(y,x) \mathcal{L}(h,y) + \sum_{n=1}^N \delta[X(n),x] \mathcal{L}(h,Y(n))}{\alpha'(x) + N'(x;D)} \\
= \left(\frac{\alpha'(x)}{\alpha'(x) + N'(x;D)}\right) \text{E}_{\yrm | \xrm}[\mathcal{L}(h,y)] + \left(\frac{N'(x;D)}{\alpha'(x) + N'(x;D)}\right) \frac{\sum_{n=1}^N \delta[X(n),x] \mathcal{L}(h,Y(n))}{\sum_{n=1}^N \delta[X(n),x]} \;.
\end{IEEEeqnarray}
...
& = & 1 - \text{E}_{\bm{\theta}} \left[ \sum_{x \in \Xcal} \text{E}_{D | \bm{\theta}} \left[ \theta\left(f(x,D),x\right) \right] \right] \\
& = & 1 - \sum_{x \in \Xcal} \frac{\text{E}_{\bar{\bm{n}}} \left[ \alpha(f(x,\bar{n}),x) + \bar{n}(f(x,\bar{n}),x) \right]}{\alpha_0 + N}
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
f^*(x,D) & = & \argmax_{y \in \Ycal} \text{P}(y | x,D) \\
...
& = & 1 - \sum_{x \in \Xcal} \frac{\text{E}_{\bar{\bm{n}}} \left[ \max_{y \in \Ycal} \left( \alpha(y,x) + \bar{n}(y,x) \right) \right]}{\alpha_0 + N}
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
f^*(x,D) & = & \mu_{\yrm|x,D}  = \text{E}_{\bm{\theta}|x,D} \left[ \mu_{y|x,\bm{\theta}} \right] \\
& = & \left( \frac{\alpha'(x)}{\alpha'(x) + N'(x;D)} \right) \sum_{y \in \Ycal} y \frac{\alpha(y,x)}{\alpha'(x)} \\
...
\begin{IEEEeqnarray}{rCl}
\text{E}_{\xrm,\nbarrm} \left[ \text{E}_{\yrm | \xrm,\nbarrm}[\yrm^2] \right] & = & \sum_{\bar{\bm{n}} \in \bar{\Ncal}} \sum_{x \in \Xcal} \text{P}(x,\bar{\bm{n}}) \sum_{y \in \Ycal} y^2 \text{P}(y | x,\bar{\bm{n}}) \\
& = & \sum_{x \in \Xcal} \sum_{y \in \Ycal} y^2 \text{E}_{\nbarrm} \left[ \text{P}(y,x | \bar{\bm{n}}) \right] \\
& = & \sum_{x \in \Xcal} \sum_{y \in \Ycal} y^2 \frac{\alpha(y,x) + \text{E}[\bar{n}(y,x)]}{\alpha_0 + N} \\
& = & \sum_{x \in \Xcal} \sum_{y \in \Ycal} y^2 \frac{\alpha(y,x)}{\alpha_0} \\
& = & \sum_{x \in \Xcal} \frac{\alpha'(x)}{\alpha_0} \sum_{y \in \Ycal} y^2 \frac{\alpha(y,x)}{\alpha'(x)} \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\xrm,\nbarrm} \left[ \left( \text{E}_{\yrm | \xrm,\nbarrm}[\yrm] \right)^2 \right] =
\sum_{\bar{\bm{n}} \in \bar{\Ncal}} \sum_{x \in \Xcal} \text{P}(x,\bar{\bm{n}}) \left( \sum_{y \in \Ycal} y \text{P}(y | x,\bar{\bm{n}}) \right)^2 \\
= \sum_{x \in \Xcal} \sum_{y \in \Ycal} y \sum_{y' \in \Ycal} y' \text{E}_{\nbarrm} \left[ \text{P}(y,x | \bar{\bm{n}}) \text{P}(y' | x,\bar{\bm{n}}) \right] \\
= \sum_{x \in \Xcal} \sum_{y \in \Ycal} y \sum_{y' \in \Ycal} y' \text{E}_{\nbarrm} \left[ \frac{(\alpha(y,x)+\bar{n}(y,x))(\alpha(y',x)+\bar{n}(y',x))}{(\alpha_0+N)(\alpha'(x) + n'(x))} \right] \\
= \sum_{x \in \Xcal} \sum_{y \in \Ycal} y \sum_{y' \in \Ycal} y' \left(\frac{\alpha'(x)}{\alpha_0}\right) \\
...
= \sum_{x \in \Xcal} \left(\frac{\alpha'(x)}{\alpha_0}\right) \sum_{y \in \Ycal} y \sum_{y' \in \Ycal} y' \\
\qquad \frac{N \frac{\alpha(y,x)}{\alpha'(x)} \delta[y,y'] + (N \alpha'(x) + \alpha_0 \alpha'(x) + \alpha_0) \frac{\alpha(y,x)}{\alpha'(x)} \frac{\alpha(y',x)}{\alpha'(x)}}{(\alpha_0+N)(\alpha'(x)+1)} \\
= \sum_{x \in \Xcal} \left(\frac{\alpha'(x)}{\alpha_0}\right) \\
\qquad \frac{N \left( \sum_{y \in \Ycal} \frac{\alpha(y,x)}{\alpha'(x)} y^2 \right) + (N \alpha'(x) + \alpha_0 \alpha'(x) + \alpha_0) \left( \sum_{y \in \Ycal} \frac{\alpha(y,x)}{\alpha'(x)} y \right)^2 }{(\alpha_0+N)(\alpha'(x)+1)} \\
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\mathcal{R}(f^*) = \text{E}_{\xrm,\nbarrm} \left[ \text{E}_{\yrm | \xrm,\nbarrm}[\yrm^2] - \left( \text{E}_{\yrm | \xrm,\nbarrm}[\yrm] \right)^2 \right] \\
= \sum_{x \in \Xcal} \frac{\alpha'(x)}{\alpha_0} \left( \frac{N \alpha'(x) + \alpha_0 \alpha'(x) + \alpha_0}{(\alpha_0+N)(\alpha'(x)+1)} \right) \\
...
= \sum_{x \in \Xcal} \frac{\alpha'(x)}{\alpha_0} \left( \frac{N \alpha'(x) + \alpha_0 \alpha'(x) + \alpha_0}{(\alpha_0+N)(\alpha'(x)+1)} \right) \Sigma_{y|x} \\
= \sum_{x \in \Xcal} \frac{\alpha'(x)}{\alpha_0} \left( \frac{\alpha'(x)/\alpha_0 + (\alpha_0+N)^{-1}}{\alpha'(x)/\alpha_0 + \alpha_0^{-1}} \right) \\
\qquad \left[ \left( \sum_{y \in \Ycal} \frac{\alpha(y,x)}{\alpha'(x)} y^2 \right) - \left( \sum_{y \in \Ycal} \frac{\alpha(y,x)}{\alpha'(x)} y \right)^2 \right] \\
...
\begin{IEEEeqnarray}{rCl}
\text{P}(y | D) & = & \text{E}_{\bm{\theta} | \Drm}[\bm{\theta} | D] \\
& = & \frac{\alpha(y) + \bar{N}(y;D)}{\alpha_0 + N} \\
& = & \left(\frac{\alpha_0}{\alpha_0+N}\right) \frac{\alpha(y)}{\alpha_0} + \left(\frac{N}{\alpha_0+N}\right) \frac{\bar{N}(y;D)}{N}
\end{IEEEeqnarray}

\begin{IEEEeqnarray}{rCl}
\text{P}(y | \bar{\bm{n}}) & = & \text{E}_{\bm{\theta} | \nbarrm} \left[ \bm{\theta} | \bar{\bm{n}} \right] \\
...
\begin{IEEEeqnarray}{rCl}
\text{p}(y | D) & = & \text{E}_{\bm{\theta} | \Drm}[\theta(y) | D] \\
...
\begin{IEEEeqnarray}{rCl}
\text{E}[D(n)] & = & \int_{\Ycal} y \text{p}_{D(n)}(y) \mathrm{d} y = \int_{\Ycal} y \text{E}_{\bm{\theta}}\text{P}_{D(n) | \bm{\theta}}(y) \mathrm{d} y \\
& = & \int_{\Ycal} y \text{E}_{\bm{\theta}} \theta(y) \mathrm{d} y \\
& = & \int_{\Ycal} y \frac{\alpha(y)}{\alpha_0} \mathrm{d} y \equiv \mu_y
\end{IEEEeqnarray}

and

\begin{IEEEeqnarray}{rCl}
\text{E}[D(n)^2] & = & \int_{\Ycal} y^2 \text{p}_{D(n)}(y) \mathrm{d} y = \int_{\Ycal} y^2 \text{E}_{\bm{\theta}}\text{P}_{D(n) | \bm{\theta}}(y) \mathrm{d} y \\
& = & \int_{\Ycal} y^2 \text{E}_{\bm{\theta}} \theta(y) \mathrm{d} y \\
& = & \int_{\Ycal} y^2 \frac{\alpha(y)}{\alpha_0} \mathrm{d} y = \text{E}[y^2]
\end{IEEEeqnarray}

\begin{IEEEeqnarray}{rCl}
\text{E}[D(n)D(n')] & = & \int_{\Ycal} \int_{\Ycal} y y' \text{p}_{D(n),D(n')}(y,y') \mathrm{d} y \mathrm{d} y' \\
& = & \int_{\Ycal} \int_{\Ycal} y y' \text{E}_{\bm{\theta}} \text{p}_{D(n)|\bm{\theta}}(y) \text{p}_{D(n')|\bm{\theta}}(y') \mathrm{d} y \mathrm{d} y' \\
& = & \int_{\Ycal} \int_{\Ycal} y y' \text{E}_{\bm{\theta}}[\theta(y) \theta(y')] \mathrm{d} y \mathrm{d} y' \\
...
\begin{IEEEeqnarray}{rCl}
\text{E}[\bar{\nrm}(y)] & = & N \frac{\alpha(y)}{\alpha_0} 
\end{IEEEeqnarray}

and the correlation function is

\begin{IEEEeqnarray}{rCl}
\text{E}[\bar{\nrm}(y) \bar{\nrm}(y')] & = & \frac{N}{\alpha_0 (\alpha_0+1)} \left[ (N-1)\alpha(y) \alpha(y') + (\alpha_0+N) \alpha(y) \delta(y-y') \right]
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\yrm | \Drm} [ \mathcal{L}(h,\yrm) ] = \int_{\Ycal} \mathcal{L}(h,y) \text{p}(y | \Drm) \mathrm{d} y \\
= \frac{\int_{\Ycal} \alpha(y) \mathcal{L}(h,y) \mathrm{d} y + \int_{\Ycal} \sum_{n=1}^N \delta(y-D(n)) \mathcal{L}(h,y) \mathrm{d} y}{\alpha_0+N} \\
= \frac{\int_{\Ycal} \alpha(y) \mathcal{L}(h,y) \mathrm{d} y + \sum_{n=1}^N \mathcal{L}(h,D(n))}{\alpha_0+N} \\
= \left( \frac{\alpha_0}{\alpha_0+N} \right) \int_{\Ycal} \frac{\alpha(y)}{\alpha_0} \mathcal{L}(h,y) \mathrm{d} y +  \left( \frac{N}{\alpha_0+N} \right) N^{-1} \sum_{n=1}^N \mathcal{L}(h,D(n)) \;.
\end{IEEEeqnarray}
...
Now we choose for the regression function to map to $\mathcal{H} = \Ycal = \mathbb{R}$.
...
f^*(D) & = & \argmin_{h \in \mathbb{R}} \text{E}_{\yrm|D} \left[ (h-\yrm)^2 \right]  \\
& = & \mu_{\yrm|D} = \text{E}_{\bm{\theta} | D} \left[ \mu_{\yrm|\bm{\theta}} \right] \\
& = & \left( \frac{\alpha_0}{\alpha_0+N} \right) \int_{\Ycal} \frac{\alpha(y)}{\alpha_0} y \mathrm{d} y +  \left( \frac{N}{\alpha_0+N} \right) \frac{1}{N} \sum_{n=1}^N D(n) \\
& = & \left( \frac{\alpha_0}{\alpha_0+N} \right) \text{E}[y] +  \left( \frac{N}{\alpha_0+N} \right) \frac{1}{N} \sum_{n=1}^N D(n) \\
& = & \left( \frac{\alpha_0}{\alpha_0+N} \right) \text{E}[y] +  \left( \frac{N}{\alpha_0+N} \right) \int_{\Ycal} y \frac{\bar{N}(y;D)}{N} \mathrm{d} y \;.
\end{IEEEeqnarray}
...
- \left( \text{E}_{\yrm | \Drm}[\yrm] \right)^2 \\
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\text{E}_{\Drm}[\text{E}_{\yrm | \Drm}[\yrm^2]] & = & \text{E}_{\yrm}[\yrm^2]
\end{IEEEeqnarray}


\begin{IEEEeqnarray}{L}
\text{E}_{\Drm}\left[ \left( \text{E}_{\yrm | \Drm}[\yrm] \right)^2 \right] \\
...
\begin{IEEEeqnarray}{L}
\text{E}_{\Drm}\left[ \left( \text{E}_{\yrm | \Drm}[\yrm] \right)^2 \right] = \text{E}_{\bar{\nrm}}\left[ \left( \text{E}_{\yrm | \bar{\nrm}}[\yrm] \right)^2 \right]\\
\quad = \frac{\alpha_0^2 \mu_y^2 + 2\alpha_0 \mu_y \int_{\Ycal} y \text{E}[\bar{\nrm}(y)] \mathrm{d} y + \int_{\Ycal} \int_{\Ycal} y y'\text{E}[\bar{\nrm}(y)\bar{\nrm}(y')] \mathrm{d} y \mathrm{d} y'}{(\alpha_0+N)^2} \\
...
\begin{IEEEeqnarray}{rCl}
\text{p}(y,x | D) & = & \text{E}_{\bm{\theta} | \Drm}[\theta(y,x) | D] \\
& = & \frac{\alpha(y,x) + \bar{N}(y,x;D)}{\alpha_0 + N} \\
...
= \int_{\Ycal} \frac{\alpha(Y(1),X(1))}{\alpha'(X(1))} \\
...
\begin{equation}
\text{E}[\Yrm(n) | \Xrm] = \mu_{\yrm|\xrm}(\Xrm(n))
\end{equation}

\begin{equation}
\text{E}[\Yrm(n)^2 | \Xrm] = \text{E}\big[ \yrm^2 | \xrm \big] (\Xrm(n))
\end{equation}

\begin{IEEEeqnarray}{rCl}
\text{E}[\Yrm(n) \Yrm(n') | \Xrm] & = & \frac{\alpha'(X(n)) \mu_{\yrm|\xrm}(\Xrm(n)) \mu_{\yrm|\xrm}(\Xrm(n')) + \text{E}\big[ \yrm^2 | \xrm \big] (\Xrm(n)) \delta(\Xrm(n) - \Xrm(n'))}{\alpha'(X(n)) + \delta(\Xrm(n) - \Xrm(n'))}
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\text{E}[\bar{\nrm}(y,x) \bar{\nrm}(y',x')] & = & \frac{N}{\alpha_0 (\alpha_0+1)} \left[ (N-1)\alpha(y,x) \alpha(y',x') + (\alpha_0+N) \alpha(y,x) \delta(y-y') \delta(x-x') \right]
\end{IEEEeqnarray}

Observe that by the aggregation principle, $\nrm'(x) = \int_{\Ycal} \bar{\nrm}(y,x) \mathrm{d}y \equiv \sum_{n=1}^N \delta(\xrm-\Xrm(n))$ is a DMP over the set $\Xcal$ with parametrizing function $\alpha' : \Xcal \mapsto \mathbb{R}_{>0}$.
...
\begin{IEEEeqnarray}{L}
\text{E}_{\yrm | \xrm,\Drm} [ \mathcal{L}(h,\yrm) ] = \int_{\Ycal} \mathcal{L}(h,y) \text{p}(y | \xrm,\Drm) \mathrm{d} y \\
= \frac{\int_{\Ycal} \alpha(y,x) \mathcal{L}(h,y) \mathrm{d} y + \int_{\Ycal} \bar{N}(y,x;D) \mathcal{L}(h,y) \mathrm{d} y}{\alpha'(x)+N'(x;D)} \\
= \frac{\int_{\Ycal} \alpha(y,x) \mathcal{L}(h,y) \mathrm{d} y + \sum_{n=1}^N \delta(x-X(n)) \mathcal{L}(h,D(n))}{\alpha'(x)+N'(x;D)} \\
= \left(\frac{\alpha'(x)}{\alpha'(x) + N'(x;D)}\right) \text{E}_{\yrm | \xrm}[\mathcal{L}(h,y)] + \left(\frac{N'(x;D)}{\alpha'(x) + N'(x;D)}\right) \frac{\sum_{n=1}^N \delta(x-X(n)) \mathcal{L}(h,Y(n))}{\sum_{n=1}^N \delta(x-X(n))} \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
f^*(x,D) & = & \mu_{\yrm|x,D}  = \text{E}_{\bm{\theta}|x,D} \left[ \mu_{y|x,\bm{\theta}} \right] \\
& = & \frac{\int_{\Ycal} y (\alpha(y,x) + \bar{N}(y,x;D)) \mathrm{d} y}{\alpha'(x) + N'(x;D)} \\
& = & \left( \frac{\alpha'(x)}{\alpha'(x) + N'(x;D)} \right) \int_{\Ycal} y \frac{\alpha(y,x)}{\alpha'(x)} \mathrm{d} y \\
...
\begin{IEEEeqnarray}{L}
\text{E}_{\xrm,\Drm}[\text{E}_{\yrm | \xrm,\Drm}[\yrm^2]] = \text{E}_{\xrm,\nbarrm}[\text{E}_{\yrm | \xrm,\nbarrm}[\yrm^2]] \\
\quad = \text{E}_{\yrm}[\yrm^2] = \int_{\Ycal} y^2 \int_{\Xcal} \frac{\alpha(y,x)}{\alpha_0} \mathrm{d} x \mathrm{d} y \\
\quad = \text{E}_{\xrm}[\text{E}_{\yrm | \xrm}[\yrm^2]] = \int_{\Xcal} \frac{\alpha'(x)}{\alpha_0} \int_{\Ycal} y^2 \frac{\alpha(y,x)}{\alpha'(x)} \mathrm{d} x \mathrm{d} y \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\xrm,\Drm} \left[ \left( \text{E}_{\yrm | \xrm,\Drm}[\yrm] \right)^2 \right] \\
\quad = \int_{\Xcal} \int_{\Dcal} \text{p}(\xrm,\Drm) \left( \int_{\Ycal} y \text{p}(y | \xrm,\Drm) \mathrm{d} y \right)^2 \mathrm{d}\Drm \mathrm{d}\xrm \\
\quad = \int_{\Xcal} \text{E}_{\Drm} \left[ \int_{\Ycal} y \text{p}(y,\xrm | \Drm) \mathrm{d} y \int_{\Ycal} y' \text{p}(y' | \xrm,\Drm) \mathrm{d} y' \right] \mathrm{d}\xrm \\ 
\quad = \int_{\Xcal} \text{E}_{\Yrm,\Xrm} \left[ \frac{ \left( \alpha'(x) \mu_{\yrm | \xrm}(x) + \sum_{n=1}^N \Yrm(n) \delta\left( x - \Xrm(n) \right) \right)^2 }{(\alpha_0+N) \left(\alpha'(x) + \sum_{n=1}^N \delta\left( x - \Xrm(n)\right) \right)} \right] \mathrm{d}\xrm \\ 
\quad = \int_{\Xcal} \text{E}_{\Xrm} \left[ \frac{ \text{E}_{\Yrm | \Xrm} \left[ \left( \alpha'(x) \mu_{y|x}(x) + \sum_{n=1}^N \Yrm(n) \delta\left( x - \Xrm(n) \right) \right)^2 \right] }{(\alpha_0+N) \left(\alpha'(x) + \sum_{n=1}^N \delta\left( x - \Xrm(n)\right) \right)} \right] \mathrm{d}\xrm \\ 
\end{IEEEeqnarray}

Evaluating the expectation over $\Yrm$ given $\Xrm$, we have

\begin{IEEEeqnarray}{L}
\text{E}_{\Yrm | \Xrm} \left[ \left( \alpha'(x) \mu_{\yrm | \xrm}(x) + \sum_{n=1}^N \Yrm(n) \delta\left( x - \Xrm(n) \right) \right)^2 \right] \\ 
= \alpha'(x)^2 \mu_{\yrm | \xrm}(x)^2 + 2\alpha'(x) \mu_{\yrm | \xrm}(x) \sum_{n=1}^N \mu_{\yrm | \xrm}(\Xrm(n)) \delta\left( x - \Xrm(n) \right) \\
\quad + \sum_{n=1}^N \text{E}[\yrm^2 | \xrm](\Xrm(n)) \delta\left( x - \Xrm(n) \right)^2 \\
\quad + \sum_{n \neq n'} \frac{\alpha'(\Xrm(n)) \mu_{\yrm | \xrm}(\Xrm(n)) \alpha'(\Xrm(n')) \mu_{\yrm | \xrm}(\Xrm(n')) + \alpha'(\Xrm(n)) \text{E}[\yrm^2 | \xrm](\Xrm(n)) \delta(\Xrm(n)-\Xrm(n'))}{\alpha'(\Xrm(n)) \alpha'(\Xrm(n')) + \alpha'(\Xrm(n)) \delta(\Xrm(n)-\Xrm(n'))} \\
\qquad \delta\left( x - \Xrm(n) \right) \delta\left( x - \Xrm(n') \right) \\
\ldots \\
= \alpha'(x)^2 \mu_{\yrm | \xrm}(x)^2 + 2\alpha'(x) \mu_{\yrm | \xrm}(x)^2 \sum_{n=1}^N \delta\left( x - \Xrm(n) \right) + \text{E}[\yrm^2 | \xrm](x) \sum_{n=1}^N \delta\left( x - \Xrm(n) \right)^2 \\
\quad + \frac{\alpha'(x) \mu_{\yrm | \xrm}(x)^2 + \text{E}[\yrm^2 | \xrm](x) \delta(0)}{\alpha'(x) + \delta(0)} \\
\qquad \sum_{n \neq n'} \delta\left( x - \Xrm(n) \right) \delta\left( x - \Xrm(n') \right) \\
\ldots \\
= \frac{\alpha'(x) + \sum_{n=1}^N \delta\left( x-\Xrm(n) \right)}{\alpha'(x) + \delta(0)} \\
\quad \left( \text{E}[\yrm^2 | \xrm](x) \delta(0) \sum_{n=1}^N \delta\left( x-\Xrm(n) \right) + \alpha'(x) \mu_{\yrm | \xrm}(x)^2 \left( \alpha'(x) + \delta(0) + \sum_{n=1}^N \delta\left( x-\Xrm(n) \right) \right) \right)
\end{IEEEeqnarray}
...
\text{E}_{\xrm,\Drm} \left[ \left( \text{E}_{\yrm | \xrm,\Drm}[\yrm] \right)^2 \right] \\
\quad = \int_{\Xcal} \text{E}_{\Xrm} \left[ \frac{ \text{E}_{\Yrm | \Xrm} \left[ \left( \alpha'(x) \mu_{y|x}(x) + \sum_{n=1}^N \Yrm(n) \delta\left( x - \Xrm(n) \right) \right)^2 \right] }{(\alpha_0+N) \left(\alpha'(x) + \sum_{n=1}^N \delta\left( x - \Xrm(n)\right) \right)} \right] \mathrm{d}\xrm \\ 
\quad = \int_{\Xcal} \frac{ \text{E}_{\Xrm} \left[ \text{E}[\yrm^2 | \xrm](x) \delta(0) \sum_{n=1}^N \delta\left( x-\Xrm(n) \right) + \alpha'(x) \mu_{\yrm | \xrm}(x)^2 \left( \alpha'(x) + \delta(0) + \sum_{n=1}^N \delta\left( x-\Xrm(n) \right) \right) \right] }{(\alpha_0+N) (\alpha'(x) + \delta(0))} \mathrm{d}\xrm \\ 
\end{IEEEeqnarray}

Evaluating the expectation over $\Xrm$,

\begin{IEEEeqnarray}{L}
\text{E}_{\Xrm} \left[ \text{E}[\yrm^2 | \xrm](x) \delta(0) \sum_{n=1}^N \delta\left( x-\Xrm(n) \right) + \alpha'(x) \mu_{\yrm | \xrm}(x)^2 \left( \alpha'(x) + \delta(0) + \sum_{n=1}^N \delta\left( x-\Xrm(n) \right) \right) \right] \\
\quad = \text{E}[\yrm^2 | \xrm](x) \delta(0) N \frac{\alpha'(x)}{\alpha_0} + \alpha'(x) \mu_{\yrm | \xrm}(x)^2 \left( \alpha'(x) + \delta(0) + N \frac{\alpha'(x)}{\alpha_0} \right) \\
\quad = \frac{\alpha'(x)}{\alpha_0} \Big( \text{E}[\yrm^2 | \xrm](x) \delta(0) N + \mu_{\yrm | \xrm}(x)^2 \left( \alpha_0 \alpha'(x) + \alpha_0 \delta(0) + N \alpha'(x) \right) \Big) \\
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\xrm,\Drm} \left[ \left( \text{E}_{\yrm | \xrm,\Drm}[\yrm] \right)^2 \right] \\
\quad = \text{E}_{\xrm} \frac{\text{E}[\yrm^2 | \xrm](x) \delta(0) N + \mu_{\yrm | \xrm}(x)^2 \left( \alpha_0 \alpha'(x) + \alpha_0 \delta(0) + N \alpha'(x) \right) }{(\alpha_0+N) (\alpha'(x) + \delta(0))} \mathrm{d}\xrm \\ 
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\mathcal{R}(f^*) = \text{E}_{\xrm,\Drm} \left[ \text{E}_{\yrm | \xrm,\Drm}[\yrm^2] - \left( \text{E}_{\yrm | \xrm,\Drm}[\yrm] \right)^2 \right] \\
= \text{E}_{\xrm} \left[ \frac{\alpha_0 \alpha'(x) + \alpha_0 \delta(0) + N \alpha'(x)}{(\alpha_0+N)(\alpha'(x)+\delta(0))} \Sigma_{\yrm | \xrm} \right] \\
= \text{E}_x \left[ \frac{\text{P}(x) + (\alpha_0+N)^{-1} \delta(0)}{\text{P}(x) + \alpha_0^{-1} \delta(0)} \Sigma_{\yrm | \xrm} \right] \\
\end{IEEEeqnarray}
...
To perform the expectation over the Dirichlet-Multinomial process $\bar{\nrm} \sim \text{DMP}(\alpha)$, split the expectation into an expectation over the marginal DMP $\nrm' \sim \text{DMP}(\alpha')$ and a conditional expectation over $\bar{\nrm}$ given $\nrm'$. The characterization of the conditional DMP are found in Appendix \ref{app:DM_agg}.

\begin{IEEEeqnarray}{L}
\text{E}_{\xrm,\nbarrm} \left[ \left( \text{E}_{\yrm | \xrm,\nbarrm}[\yrm] \right)^2 \right] \\
\quad = \int_{\Xcal} \int_{\bar{\Ncal}} \text{p}(\xrm,\nbarrm) \left( \int_{\Ycal} y \text{p}(y | \xrm,\nbarrm) \mathrm{d} y \right)^2 \mathrm{d}\nbarrm \mathrm{d}\xrm \\
\quad = \int_{\Xcal} \text{E}_{\nbarrm} \left[ \int_{\Ycal} y \text{p}(y,\xrm | \nbarrm) \mathrm{d} y \int_{\Ycal} y' \text{p}(y' | \xrm,\nbarrm) \mathrm{d} y' \right] \mathrm{d}\xrm \\ 
\quad = \int_{\Xcal} \text{E}_{\nrm'} \left[ \frac{ \text{E}_{\bar{\nrm} | \nrm'} \left[ \left( \alpha'(x) \mu_{y|x}(x) + \int_{\Ycal} y \bar{\nrm}(y,x) \mathrm{d}y \right)^2 \right] }{(\alpha_0+N) \left(\alpha'(x) + \nrm'(x) \right)} \right] \mathrm{d}\xrm \\ 
\end{IEEEeqnarray}
...
\quad = \alpha'(x)^2 \mu_{y|x}(x)^2 + 2 \alpha'(x) \mu_{y|x}(x) \int_{\Ycal} y \delta(0) \frac{\nrm'(x)}{\delta(0)} \frac{\delta(0)^{-1} \alpha(y,x)}{\delta(0)^{-1} \alpha'(x)} \mathrm{d}y \\
\qquad + \delta(0)^2 \frac{\delta(0)^{-1} \nrm'(x)}{(\delta(0)^{-1}\alpha'(x))(\delta(0)^{-1}\alpha'(x) + 1)} \int_{\Ycal} \int_{\Ycal} y y' \Bigg[ \left( \frac{\nrm'(x)}{\delta(0)} - 1 \right) \frac{\alpha(y,x)}{\delta(0)} \frac{\alpha(y',x)}{\delta(0)} \\
\qquad + \left( \frac{\alpha'(x)}{\delta(0)} + \frac{\nrm'(x)}{\delta(0)} \right) \frac{\alpha(y,x)}{\delta(0)} \delta(y-y') \Bigg] \mathrm{d}y \mathrm{d}y' \\
\quad = \alpha'(x)^2 \mu_{y|x}(x)^2 + 2 \alpha'(x) \nrm'(x) \mu_{y|x}(x)^2 \\
\qquad + \frac{\nrm'(x)}{\alpha'(x)(\alpha'(x)+\delta(0))} \left[ (\nrm'(x) - \delta(0)) \alpha'(x)^2 \mu_{y|x}(x)^2 + \delta(0) (\alpha'(x)+\nrm'(x)) \alpha'(x) \text{E}[\yrm^2 | \xrm](x) \right] \\
\quad = \frac{\alpha'(x)+\nrm'(x)}{\alpha'(x)+\delta(0)} \Big[ \mu_{y|x}(x)^2 \alpha'(x)(\alpha'(x) + \nrm'(x) + \delta(0)) + \text{E}[\yrm^2 | \xrm](x) \delta(0) \nrm'(x) \Big] \\
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{L}
\text{E}_{\xrm,\nbarrm} \left[ \left( \text{E}_{\yrm | \xrm,\nbarrm}[\yrm] \right)^2 \right] \\
\quad = \int_{\Xcal} \frac{ \text{E}_{\nrm'} \left[ \mu_{y|x}(x)^2 \alpha'(x)(\alpha'(x) + \nrm'(x) + \delta(0)) + \text{E}[\yrm^2 | \xrm](x) \delta(0) \nrm'(x) \right] }{(\alpha_0+N) (\alpha'(x)+\delta(0))} \mathrm{d}\xrm \\ 
\quad = \int_{\Xcal} \frac{\mu_{y|x}(x)^2 \alpha'(x)(\alpha'(x) + N \alpha_0^{-1} \alpha'(x) + \delta(0)) + \text{E}[\yrm^2 | \xrm](x) \delta(0) N \alpha_0^{-1} \alpha'(x)}{(\alpha_0+N) (\alpha'(x)+\delta(0))} \mathrm{d}\xrm \\ 
\quad = \int_{\Xcal} \frac{\alpha'(x)}{\alpha_0} \frac{\mu_{y|x}(x)^2 (\alpha_0 \alpha'(x) + N \alpha'(x) + \delta(0) \alpha_0) + \text{E}[\yrm^2 | \xrm](x) \delta(0) N}{(\alpha_0+N) (\alpha'(x)+\delta(0))} \mathrm{d}\xrm \\ 
\end{IEEEeqnarray}

Combining produces the risk,

\begin{IEEEeqnarray}{L}
\mathcal{R}(f^*) = \text{E}_{\xrm} \left[ \frac{\alpha_0 \alpha'(x) + \alpha_0 \delta(0) + N \alpha'(x)}{(\alpha_0+N)(\alpha'(x)+\delta(0))} \Sigma_{\yrm | \xrm} \right] \\
= \text{E}_x \left[ \frac{\text{P}(x) + (\alpha_0+N)^{-1} \delta(0)}{\text{P}(x) + \alpha_0^{-1} \delta(0)} \Sigma_{\yrm | \xrm} \right] \\
\end{IEEEeqnarray}

...
\begin{itemize}
\item Concentration parameters $\alpha'(x) \equiv \sum_{y \in \Ycal} \alpha(y,x)$ enable both subjective and non-informative priors
...
\begin{itemize}
\item Full support over distribution space ensures identification of model $\tilde{\uptheta}(x)$ as $n'(x) \equiv \sum_y \bar{n}(y,x) \to \infty$
\end{itemize}

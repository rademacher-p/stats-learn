...
%\begin{IEEEeqnarray}{rCl}
%\text{E}_{\bar{\bm{\mathrm{n}}}} \left[ \frac{(\bar{n}_{m_y,m_x}+1)(\bar{n}_{m'_y,m_x}+1)}{\sum_{m''_y=1}^{M_y}\bar{n}_{m''_y,m_x} + M_y} \right] & = & \sum_{k=0}^N \text{P} \left( \sum_{m_y=1}^{M_y}\bar{n}_{m_y,m_x} = k \right) \text{E}\left[  \right]
%\end{IEEEeqnarray}

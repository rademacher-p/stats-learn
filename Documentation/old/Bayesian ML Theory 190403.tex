...
PGR: interpret conditional risk as a functional???
...
PGR: add discussion of risk components. irreducible vs learning?
...
\begin{IEEEeqnarray}{rCl}
\prm\big( \Drm_{n+1} | \Drm_n,\ldots,\Drm_1 \big) & = & \frac{\alpha\big( \Drm_{n+1} \big) + \sum_{n'=1}^N \delta\big( \Drm_{n+1} - \Drm_{n'} \big)}{\alpha_0 + N} \;
\end{IEEEeqnarray}

...
The weighting factors are dependent on these values as well. For $n'(x) = 0$ or as $\alpha'(x) \to \infty$, the PMF trends toward the data-independent distribution; as the number of training examples increases or as $\alpha'(x) \to 0$, $\Prm_{\yrm | \xrm,\nbarrm}$ trends towards the empirical conditional distribution. 

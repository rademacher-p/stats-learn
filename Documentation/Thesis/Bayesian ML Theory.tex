...
\DeclareMathOperator{\Xcals}{\Xcal_{\mathrm{s}}}
...
Following a procedure similar to that employed in Section \ref{sec:predictive_est_dir}, the covariance of the estimate in terms of the transformed value $\trm$ is

...
\begin{equation}
\uppsic(x) | \uppsim(x), \upthetac(x) \sim \EP\big(\Delta N \uppsim(x), \upthetac(x)\big)
\end{equation}
...
\todohigh{FIXXXXXXXX!!!! Use delta(0) notation as EP...}

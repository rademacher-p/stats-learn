...
\end{IEEEeqnarray}
Note that the former is equivalent to the first inverse moment of a positive binomial random variable \cite{stephan}.
...
\todohigh{add delta mixture trends}

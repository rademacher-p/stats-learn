...
\todohi{empirical risk terms/discussion?}
...
& = &  \mu_{\yrm | \xrm,\uptheta} \nonumber \;. %= \sum_{y \in \Ycal} y \tilde{\uptheta}(y;\xrm) 
\end{IEEEeqnarray}

...
\subsubsection{Minimum Bayes Risk: the Expected Posterior Variance}
...
\subsubsection{Minimum Bayes Risk: Probability of Error}
...
\subsubsection{Minimum Bayes Risk}

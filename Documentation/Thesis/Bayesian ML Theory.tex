...
\todohigh{otimes for all? ordered set?}
...
\end{IEEEeqnarray}
To determine the second order conditional distributions, first note that for $\Xrm_n \neq \Xrm_{n'}$, $\Prm_{\Yrm_n,\Yrm_{n'} | \Xrm_n,\Xrm_{n'}} = \mu_{\upthetac(\Xrm_n)} \otimes \mu_{\upthetac(\Xrm_{n'})} = \alphac(\Xrm_n) \otimes \alphac(\Xrm_{n'})$. Contrasting, if $\Xrm_n = \Xrm_{n'}$, then
\begin{IEEEeqnarray}{L}
...
\end{IEEEeqnarray}
Combining, the formula for the second order distribution is
\begin{IEEEeqnarray}{L}
...
\begin{IEEEeqnarray}{L}
\Erm_{\uppsi}\big[ \uppsi(y,x) \uppsi(y',x') \big] \\
\qquad = \frac{\alpha_0^{-1} + N^{-1}}{1 + \alpha_0^{-1}} \alpha(y,x) \delta(y-y') \delta(x-x') + \frac{1 - N^{-1}}{1 + \alpha_0^{-1}} \alpha(y,x) \alpha(y',x')  \nonumber \;.
\end{IEEEeqnarray}

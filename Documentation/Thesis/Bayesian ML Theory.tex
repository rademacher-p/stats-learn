...
\end{equation}
and $\Psim(z;\Drm) = \int_{\Scal_z} \Psi(y;D) \mathrm{d} y = N^{-1} \sum_{n=1}^N \chi\big( \Drm_n;\Scal_z \big)$. $\chi$ is the indicator function
\begin{equation}

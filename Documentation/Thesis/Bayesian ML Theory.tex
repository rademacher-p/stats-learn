...
\todohigh{Consider notation $\mu_{\upthetac | \xrm,\Drm}(\xrm; \xrm,\Drm)$ !?!?}
...
\begin{IEEEeqnarray}{rCl}
\Prm_{\yrm | \xrm,\Drm}(x,D) & = & \mu_{\upthetac | \xrm,\Drm}(x; x,D) = \mu_{\upthetac | \Drm}(x; D) \;.
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
\prm_{\xrm | \Drm} \equiv \prm_{\xrm | \Xrm} & = & \left(\frac{\alpha_0}{\alpha_0+N}\right) \alpham + \left(\frac{N}{\alpha_0+N}\right) \Psim(\Xrm) \;,
\end{IEEEeqnarray}

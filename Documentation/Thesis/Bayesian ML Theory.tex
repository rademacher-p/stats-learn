...
By the aggregation property \cite{ferguson}, $\upthetam$ is a Dirichlet random process parameterized by $\alpha_0 \alpham$. Note that $\Prm_{\xrm} = \mu_{\upthetam} = \alpham$.

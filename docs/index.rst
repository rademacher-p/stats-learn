...
(i.e. probability distributions) of the joint :math:`\xrm` and :math:`\xrm` random elements. By defining the conditional
...
and thus the prediction function. For learning predictors, :doc:`Bayesian models <source/stats_learn.bayes>` provide
